...
public class CheckDataUtil {
	 ...
	 */
	public static void checkNull(String text, String errorName) throws WorkFlowException {
		if (isNull(text)) {
			throw new WorkFlowException("60504", errorName + "不能为空!");
		}
	}
	
	public static void checkNull(Object obj, String errorName) throws WorkFlowException {
		if (isNull(obj)) {
			throw new WorkFlowException("60504", errorName + "不能为空!");
		}
	}
	 ...
	 * @throws WorkFlowException 
	 */
	public static void checkStringLenght(String text, int len, String errorName, boolean isNull) throws WorkFlowException {
		if (!isNull) {
			checkNull(text, errorName);
		}
		if (text.length() > len) {
			throw new WorkFlowException("60504",  errorName + "不能超过 " + len + " 个字!");
		}
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(isIdCardNo("310115198502146114"));
