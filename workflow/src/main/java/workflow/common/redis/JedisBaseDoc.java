...
public abstract class JedisBaseDoc {
	 ...
	 * 
	 */
	public static <T extends JedisBaseDoc> T Load(StringRedisTemplate stringRedisTemplate, String key, Class<T> clazz)
	 ...
	 * 
	 */
	public static <T extends JedisBaseDoc> T Load(StringRedisTemplate stringRedisTemplate, String key, Class<T> clazz, String... params)
