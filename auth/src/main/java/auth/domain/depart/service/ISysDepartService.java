package auth.domain.depart.service;
 ...
 * @Since：   2019-01-22
 */
public interface ISysDepartService extends IService<Depart>{
     ...
     * @return
     */
    Boolean updateDepartDataById(Depart Depart,String username);
     ...
     * @return
     */
    List<Depart> queryDepartsByUsername(String username);
