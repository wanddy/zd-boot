package auth.domain.user.mapper;
...
public interface UserMapper extends BaseMapper<User> {
    ...
    void freeZeOrThawUsers(@Param("userIds") List<String> userIds, @Param("status") Integer status);
     ...
     * @return
     */
    IPage<User> getUserByDepId(Page page, @Param("departId") String departId, @Param("username") String username);
     ...
     * @return
     */
    IPage<User> getUserByDepIds(Page page, @Param("departIds") List<String> departIds, @Param("username") String username);
     ...
     * @return
     */
    List<SysUserSysDepartModel> getUserByOrgCode(IPage page, @Param("orgCode") String orgCode, @Param("userParams") User userParams);
     ...
     * @return
     */
    Integer getUserByOrgCodeTotal(@Param("orgCode") String orgCode, @Param("userParams") User userParams);
     ...
     * @return
     */
    List<User> queryByDepIds(@Param("departIds") List<String> departIds, @Param("username") String username);
}
