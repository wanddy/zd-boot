package auth.domain.check.service.impl;
...
import auth.domain.check.mapper.SysCheckRuleMapper;
...
@Slf4j
@Service
public class SysCheckRuleServiceImpl extends ServiceImpl<SysCheckRuleMapper, CheckRule> implements ISysCheckRuleService {

    @Override
    public CheckRule getByCode(String ruleCode) {
