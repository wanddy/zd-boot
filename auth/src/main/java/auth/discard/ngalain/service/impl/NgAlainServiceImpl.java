package auth.discard.ngalain.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import commons.util.oConvertUtils;
import auth.discard.ngalain.mapper.NgAlainMapper;
import auth.discard.ngalain.service.NgAlainService;
...
public class NgAlainServiceImpl implements NgAlainService {
    ...
    public JSONArray getJeecgMenu(String id) throws Exception {
        List<Permission> metaList = sysPermissionService.queryByUser(id);
