...
public class FindsDepartsChildrenUtil {
     ...
     */
    public static List<SysDepartTreeModel> wrapTreeDataToTreeList(List<Depart> recordList) {
        // 在该方法每请求一次,都要对全局list集合进行一次清理
        //idList.clear();
        List<DepartIdModel> idList = new ArrayList<>();
        List<SysDepartTreeModel> records = new ArrayList<>();
        for (Depart depart : recordList) {
     ...
     * 获取 DepartIdModel
     */
    public static List<DepartIdModel> wrapTreeDataToDepartIdTreeList(List<Depart> recordList) {
        // 在该方法每请求一次,都要对全局list集合进行一次清理
        //idList.clear();
        List<DepartIdModel> idList = new ArrayList<>();
        List<SysDepartTreeModel> records = new ArrayList<>();
