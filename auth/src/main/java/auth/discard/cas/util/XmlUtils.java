...
public final class XmlUtils {
    ...
    /**
     * Creates ColumnMetaUtils new namespace-aware DOM document object by parsing the given XML.
     *
    ...
    /**
     * Retrieve the text for ColumnMetaUtils group of elements. Each text element is an entry
     * in ColumnMetaUtils list.
     * <p>This method is currently optimized for the use case of two elements in ColumnMetaUtils list.
     *
    ...
    /**
     * Retrieve the text for ColumnMetaUtils specific element (when we know there is only
     * one).
     *
     * @param xmlAsString the xml response
     * @param element     the element to look for
