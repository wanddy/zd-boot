...
public class OrgCodeRule implements IFillRuleHandler {
    ...
    public Object execute(JSONObject params, JSONObject formData) {
        ...
        LambdaQueryWrapper<Depart> query1 = new LambdaQueryWrapper<Depart>();
        ...
        System.out.printf("--------------------------PID：" + parentId);
        ...
        if (StringUtils.isEmpty(parentId)) {
            ...
            // 查询出同级部门的集合
            List<Depart> parentList = sysDepartService.list(query);
            // 查询出父级部门
            Depart depart = sysDepartService.getById(parentId);
            // 获取父级部门的Code
