//
// Source code recreated from GenUtilsIm .class file by IntelliJ IDEA
...
public class GenUtilsIm {
    private static final Logger c = LoggerFactory.getLogger(GenUtilsIm.class);
    ...
    public static List<File> a(File var0) throws IOException {
        ...
        a(var0, var1);
        var1.sort(Comparator.comparing(File::getAbsolutePath).reversed());
//        Collections.sort(var1, new Comparator<File>() {
//            public int DataBaseUtils(File var1, File var2) {
