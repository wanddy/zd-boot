package smartcode.form.dynamic.db;
...
public class SqlUtils {
    ...
    public static final String POSTGRE__ALLTABLES_SQL = "SELECT distinct OnlCgreportItemController.relname AS  table_name FROM pg_class OnlCgreportItemController";
    ...
    public static final String SQLSERVER__ALLTABLES_SQL = "select distinct OnlCgreportItemController.name as  table_name from sys.objects OnlCgreportItemController";
