package webapi.authController.config;
...
public class DictAspect {
    ...
    // 定义切点Pointcut
    //@Pointcut("execution(public * webapi.authController.*Controller.*(..))||execution(public * *.*.*Controller.*(..))")
    @Pointcut("execution(public * *.*.*Controller.*(..)) || execution(public * *.*.*.*.*Controller.*(..)) || execution(public * *.*.*.*Controller.*(..))")
